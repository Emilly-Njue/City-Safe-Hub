...
<head>
    ...
    <title> City-Safe Hub Admin Login</title>
                            ...
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form class="user" method="post" action="{{url('admin/login')}}">
                                        ...
                                        <div class="form-group">
                                            <input name="password" type="password" class="form-control form-control-user" @if(Cookie::has('adminpwd')) value="{{Cookie::get('adminpwd')}}" @endif
